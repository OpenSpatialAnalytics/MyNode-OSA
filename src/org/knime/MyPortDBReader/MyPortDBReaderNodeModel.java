...
/**
 * This is the model implementation of MyPortDBReader.
 * This is a testing my Database Port. TG
 *
 * @author TG
 */
public class MyPortDBReaderNodeModel extends NodeModel implements FlowVariableProvider {
	 ...
	 // the logger instance
	   /* private static final NodeLogger logger = NodeLogger
	     ...
	     */
	    protected MyPortDBReaderNodeModel(final PortType[] inPortTypes, final PortType[] outPortTypes) {
	     ...
	     */
	    MyPortDBReaderNodeModel(final int ins, final int outs) {
	        super(ins, outs);
	    }
	    ...
	    protected DBReader loadConnectionSettings(final PortObject dbPortObject) throws InvalidSettingsException {
	        ...
	        if ((dbPortObject instanceof MyDatabaseConnPortObject)) {
	        	MyDatabaseConnPortObject dbObj = (MyDatabaseConnPortObject)dbPortObject;
	    ...
	    private boolean hasDatabaseInputConnection(final PortObjectSpec[] inSpecs) {
	        return (inSpecs.length > getNrInPorts() - 1)
	                && (inSpecs[getNrInPorts() - 1] instanceof MyDatabaseConnPortObjectSpec);
	    }
	    ...
	    protected DataTableSpec getResultSpec(final PortObjectSpec[] inSpecs)
	        ...
	        if (hasDatabaseInputConnection(inSpecs)) {
	        	MyDatabaseConnPortObjectSpec connSpec =
	                (MyDatabaseConnPortObjectSpec)inSpecs[getNrInPorts() - 1];
