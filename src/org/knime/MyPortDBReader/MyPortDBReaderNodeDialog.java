...
/**
 * <code>NodeDialog</code> for the "MyPortDBReader" Node.
 ...
 * @author TG
 */
// this is similar to DBReaderDialogPane in Knime source code, but change to MyDatabaseConnPortObjectSpec for the specific port object

//public class MyPortDBReaderNodeDialog extends DefaultNodeSettingsPane {
public class MyPortDBReaderNodeDialog extends NodeDialogPane {
	     ...
	     */
	    public MyPortDBReaderNodeDialog(final boolean showConnectionPanel, final boolean showDBBrowser) {
	...
	// init variable list
	    ...
	    protected void loadSettingsFrom(final NodeSettingsRO settings,
	        ...
	        for (PortObjectSpec pos : specs) {
	            if (pos instanceof MyDatabaseConnPortObjectSpec) {
	                try {
	                    m_upstreamConnectionSettings =
	                        ((MyDatabaseConnPortObjectSpec)pos).getConnectionSettings(getCredentialsProvider());
	                } catch (InvalidSettingsException ex) {
