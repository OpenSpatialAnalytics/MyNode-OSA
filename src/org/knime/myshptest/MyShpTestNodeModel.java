...
/**
 * This is the model implementation of MyShpTest.
 * This is test for shpobject. TG
 *
 * @author TG
 */
public class MyShpTestNodeModel extends NodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(MyShpTestNodeModel.class);
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(MyShpTestNodeModel.CFGKEY_COUNT,
     ...
     */
    protected MyShpTestNodeModel(final PortType[] inPortTypes, final PortType[] outPortTypes) {
     ...
     */
    MyShpTestNodeModel(final int ins, final int outs) {
        super(ins, outs);
    }
    //TG 0714 E
